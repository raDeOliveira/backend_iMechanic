...
namespace backend_iMechanic.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] User user)
        {
            ...
            //var exists = users.Where(x => x.Name.Equals(user.Name) && x.Password.Equals(user.Password)).FirstOrDefault();
            var exists = users.Where(x => x.Name.Equals(user.Name)).FirstOrDefault();
