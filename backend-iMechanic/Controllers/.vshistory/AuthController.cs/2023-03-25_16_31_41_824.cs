...
namespace backend_iMechanic.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] User user)
        {
            ...
            var userExists = _context.Users.Where(u => u.Email.Equals(user.Email)).FirstOrDefault();
            if (userExists != null)
            {
        ...
        public IActionResult Signup([FromBody] User user)
        {
            ...
            // add user in DB
            _context.Database
                .ExecuteSqlRaw("INSERT INTO Users (Name, Email, Password) VALUES ({0}, {1})", user.Name, user.Email, user.Password);
        }
    }
}
