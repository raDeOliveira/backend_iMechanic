...
namespace backend_iMechanic.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Login([FromBody] User user)
        {
            ...
            var userExists = _context.User.Where(u => u.Name.Equals(user.Name) | u.Email.Equals(user.Email) && u.Password.Equals(user.Password)).FirstOrDefault();
            if (userExists != null)
            {
        ...
        public IActionResult Signup([FromBody] User user)
        {
            ...
            var addUser = _context.Database
                .ExecuteSqlRaw("INSERT INTO [USER] (Name, Email, Password) VALUES ({0}, {1}, {2})", user.Name, user.Email, user.Password);
