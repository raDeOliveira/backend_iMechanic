...
namespace backend_iMechanic.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        public IEnumerable<string> GetSelectedCar(string brand, string model, string fuel)
        {
            if (_context.Cars == null)
            {
                return (IEnumerable<string>)NotFound();
            ...
            var car = _context.Database
                .SqlQuery<string>($"select distinct engine_fuel from cars where engine_fuel is not null")
                .ToList();
