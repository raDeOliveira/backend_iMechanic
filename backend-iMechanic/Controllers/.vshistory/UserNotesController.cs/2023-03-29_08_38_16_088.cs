...
namespace backend_iMechanic.Controllers
{
    ...
    public class UserNotesController : ControllerBase
    {
        ...
        public IActionResult PostUserNotes([FromBody] UserNote userNote)
        {
            ...
            var insertUserNote = _context.Database.ExecuteSqlRaw($"INSERT INTO USER_NOTES (ID_USER, USER_NOTES, CAR_ID) VALUES {1}, {2}, {3}", userNote.Id_User, userNote.Notes, userNote.Id_Choosen_Car);
            _context.Add(insertUserNote);
