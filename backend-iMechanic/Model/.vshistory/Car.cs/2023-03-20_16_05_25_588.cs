namespace backend_iMechanic.Model
{
    public class Car
    {
        ...
        public string Performance_TopSpeed { get; set; }
        public string Performance_Acceleration { get; set; }
        ...
        public string Transmission_DriveType { get; set; }
